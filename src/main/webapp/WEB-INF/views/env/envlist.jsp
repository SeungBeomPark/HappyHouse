...
<html>
	<head>
		...
		<script>
			function searchEnv() {
				...
				document.getElementById("searchform").action = "listEnv.do";
			...
			var tmpdata = [];
			var first = ['구 분류', '점검완료 수'];//그래프에 나타낼 항목 배열 선언
			tmpdata.push(first);
	...
	<body>
	  ...
	  <p align="center">구 이름으로 검색, 동 이름으로 검색이 가능합니다</p> 
